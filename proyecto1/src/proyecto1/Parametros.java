...
public class Parametros extends javax.swing.JFrame {
    ...
    try {
        ...
        if (verificarYProceder()) {
            ...
            Integer narrativa1 = Integer.valueOf(jTable1.getValueAt(0, 0).toString());
            Integer niveles1 = Integer.valueOf(jTable1.getValueAt(1, 0).toString());
            Integer sprites1 = Integer.valueOf(jTable1.getValueAt(2, 0).toString());
            Integer logica1 = Integer.valueOf(jTable1.getValueAt(3, 0).toString());
